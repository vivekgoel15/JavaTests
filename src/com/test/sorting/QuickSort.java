 ...
 * then recursively sort the sub-lists. - See more at:
 * http://www.java2novice.com/java-sorting-algorithms/quick-sort/#sthash.sLp8Wb0T.dpuf
 * 
 * @author vigoel
 *
 */
public class QuickSort {
	...
	public static void main(String a[]) {
		 ...
		 * 
		 * 1) Choose an element, called pivot, from the list. Generally pivot
		 * can be the middle index element. 2) Reorder the list so that all
		 * elements with values less than the pivot come before the pivot, while
		 ...
		 * its final position. This is called the partition operation. 3)

...
class File implements AbstractFile {
	...
	public void ls() {
		System.out.println(CompositeDemo2.compositeBuilder + name);
	}
}
...
class Directory implements AbstractFile {
	...
	public void ls() {
		System.out.println(CompositeDemo2.compositeBuilder + name);
		CompositeDemo2.compositeBuilder.append("   ");
		for (Object includedFile : includedFiles) {
			// Leverage the "lowest common denominator"
			AbstractFile obj = (AbstractFile) includedFile;
			obj.ls();
		}
		CompositeDemo2.compositeBuilder.setLength(CompositeDemo2.compositeBuilder.length() - 3);
	}
}

...
public class BigDecimalVSDouble {
	...
	public static void main(String[] args) {
		...
		// Main Difference 1 - BigDecimal provides more control on how rounding is done and thus provide more accurate output
...
//		System.out.println(new BigDecimal(1000.0).add(new BigDecimal(0.0001)));
//		System.out.println(new BigDecimal("1000.0").add(new BigDecimal("0.0001")));
//		
...
//		System.out.println( new BigDecimal(0.1d).add(new BigDecimal(0.1d)).add(new BigDecimal(0.1d)).add(new BigDecimal(0.1d))
//				.add(new BigDecimal(0.1d)).add(new BigDecimal(0.1d)).add(new BigDecimal(0.1d)).add(new BigDecimal(0.1d))
